...
/*   Updated: 2025/08/19 14:18:18 by mbiagi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(): ClapTrap("mavi")
{
	...
	std::cout<<"derivated constructing "<<getName()<<std::endl;
}
...
ScavTrap::~ScavTrap()
{
	std::cout<<"derivated destroing "<<getName()<<std::endl;
}
...
void ScavTrap::attack(const std::string& target)
{
	if (getEnergyPoint() > 0)
	{
		std::cout<<getName()<<" kicked "<<target<<" so hard it caused "
